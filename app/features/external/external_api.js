...
import { urlObjectToString } from '../external/uri';
import {
...
export default class JitsiMeetExternalAPI extends EventEmitter {
    ...
    constructor(domain, ...args) {
        ...
        const localStorageContent = localStorage.getItem('localStorage');
    ...
    _setupListeners() {
        this._transport.on('event', ({ name, ...data }) => {
            ...
            case 'local-storage-changed':
                localStorage.setItem('localStorage', data.localStorageContent);
